<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="GraphTrial.aspx.cs" Inherits="ProtoType.GraphTrial" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cplMain" runat="server">
    ...
    <script type="text/javascript">
        ...
        function chartdata(displayType, department, selectedValue, selectedValueEC,selectedValueRD) {
            ...
            $.ajax({
                url: "GraphTrial.aspx/" + methodName,
