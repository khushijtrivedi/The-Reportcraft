<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="HalfYearlyColumn.aspx.cs" Inherits="ProtoType.HalfYearlyColumn" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            if (sv == '' && svRD !== '' && svEC=='') {
                ...
                chartdata('column', '', '', '',svRD);
            }
            if (sv == '' && svRD == '' && svEC !== '') {

                chartdata('column', '', '', svEC, '');
            }
            else {
                chartdata('column', '', '','','');
            }
        ...
        function chartdata(displayType, department, selectedValue, selectedValueEC,selectedValueRD) {
            ...
            $.ajax({
                url: "HalfYearlyColumn.aspx/" + methodName,
