...
namespace ProtoType
{
    public partial class Availability : System.Web.UI.Page
    {
        ...
        protected void btnpdf_Click(object sender, EventArgs e)
        {
            ...
            Paragraph reportTitle = new Paragraph("DEPARTMENT AVAILABILITY", reportTitleFont);
            ...
            Response.AddHeader("Content-Disposition", "attachment;filename=AvailabilityReport.pdf");
