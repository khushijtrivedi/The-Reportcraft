<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ColumAnnual.aspx.cs" Inherits="ProtoType.ColumAnnual" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cplMain" runat="server">
    ...
    <script type="text/javascript">
        ...
        function chartdata(displayType, department, selectedValue, selectedValueEC,selectedValueRD) {
            ...
            $.ajax({
                url: "ColumAnnual.aspx/" + methodName,
